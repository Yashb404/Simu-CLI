  ...
  theme: {
    extend: {
      colors: {
        ...
        "surface-bright": "var(--surface-bright, #2b2c32)",
        "surface-dim": "var(--surface-dim, #0e0e10)",
        "surface-variant": "var(--surface-variant, #25252b)",
        "surface-tint": "var(--surface-tint, #4ae176)",
        outline: "var(--border)",
